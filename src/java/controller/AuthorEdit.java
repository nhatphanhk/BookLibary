 ...
 * @author nhatp
 */
@WebServlet(name = "AuthorEdit", urlPatterns = {"/author-edit"})
public class AuthorEdit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Author list = authorDao.getStudentById(id);
        request.setAttribute("data", list);
        request.getRequestDispatcher("author-edit.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        a1.update(a);
        response.sendRedirect("author-list");
    }
