...
<body style="background-color: #f0f1f2;">
	...
	<div class="container">
        ...
        <h3><a href="book-add">Add New Book</a>
                            ...
                            <tbody>
                                <c:forEach items = "${requestScope.data}" var="c">
                                    <tr>
                                        ...
                                        <td>${c.amount}</td>
                                        <td>
                                            <img src="${c.img}" width="50px" height="100px" alt="alt"/>
                                        </td>
                                        
                                   
                                        <td>
                                            <a class="btn btn-danger" href="book-edit?id=${c.id}"  role="button">Edit</a>
    ...
    <script>
        function doDelete(id){
            if(confirm("Are you want to delete Student with ID = "+id )){
                window.location="book-delete?id="+id;
            }
        }
    </script>
	<script>
