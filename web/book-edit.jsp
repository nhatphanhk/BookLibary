    ...
    <body style="background-color: #f0f1f2;">
        ...
        <div class="container">
            ...
            <form action="book-add" method="POST">
                <input type="text" class="form-control" name="name" placeholder="Enter name" value="${e.name}">
                <textarea class="form-control" name="description" id="description">${e.description}</textarea>
                ...
                <input type="number" class="form-control" name="amount" placeholder="Enter amount" value="${e.amount}">
                <input type="text" class="form-control" name="img" placeholder="Image" value="${e.img}">
